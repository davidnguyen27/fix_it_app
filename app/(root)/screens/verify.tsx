...
import { View, Text, TextInput, TouchableOpacity, ImageBackground, Image, NativeSyntheticEvent, TextInputKeyPressEventData } from "react-native";
...
const Verify = () => {
  ...
  const handleResendCode = async () => {
    if (timer === 0) {
      ...
      try {
        await forgetPassword(email as string);
          ...
          const handleChangePassword = async () => {
            if (password === confirmPassword) {
              ...
              try {
                ...
                router.push("/(root)/screens/sign-in"); // Redirect to Sign In page
              } catch (error) {
          ...
          return (
            ...
            >
              <View className="flex-1 px-6">
                ...
                >
                  <Text
                    className={`font-unbounded-semiBold text-[13px] text-center underline mt-3 mb-8 ${timer > 0
                ...
                <Button
                  ...
                  backgroundColor="bg-[#4A628A]"
                  onPress={handleChangePassword} // Call resetPassword on button press
                />
              </View>
            </ImageBackground>
          );
